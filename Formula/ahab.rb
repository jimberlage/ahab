class Ahab < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jimberlage/ahab/releases/download/v2.0.0/ahab-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/jimberlage/ahab/releases/download/v2.0.0/ahab-aarch64-linux.tar.gz"
      sha256 "88a01625387c3d8610f437ec061b74f24b7e06f9669874b029106021ee37965d"
    end
    on_intel do
      url "https://github.com/jimberlage/ahab/releases/download/v2.0.0/ahab-x86_64-linux.tar.gz"
